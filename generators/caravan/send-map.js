...
async function generateSendMap(user, stats, mora) {
    ...
    for (let i=0; i<DESTS.length; i++) {
        ...
        if(destImg) {
            ...
            // رسم إيموجي بديل إذا لم توجد صورة
            ctx.font = `60px ${FE}`; ctx.textAlign = 'center';
        ...
        let adjDur, adjRisk;
        try { 
            // 👑 استخدام الحسابات من الهاندرلر الموحد
